...
module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "Terris",
  description: "Ảnh Gái Cosplay có trả phí",
...
var min = Math.floor(Math.random() * 2);
  ...
  var money = data.money
      if(money < 10000) api.sendMessage("Bạn cần 10000 đô để xem ảnh nha",event.threadID,event.messageID)
          else {
   Currencies.setData(event.senderID, options = {money: money - 10000})
   var callback = () => api.sendMessage({body:`Ảnh gái Cosplay\nSố Ảnh: ${link.length}\n-10000 đô nha bạn iu !`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"), event.messageID); 
