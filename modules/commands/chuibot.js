...
module.exports.handleEvent = async ({
	...
	var h = {
		body: `»Thông báo từ Admin«\n\n${c}, Bạn thật ngu ngok khi chửi bot (hoặc đã chửi admin) vì vậy bot đã tự động ban bạn khỏi hệ thống\n\n💌Liên hệ Admin:https://www.facebook.com/profile.php?id=100086116031465\nđể được gỡ ban bạn nhé \n\n🎭Thả tym cho bạn nè <3`
	};
    //Thêm các câu chửi vào ko viết Hoa
	["botngu", "bot ngu", "con bot lol", "bot ngu lol", "bot chó", "dm bot", "đm bot", "dmm bot", "dmm bot", "đmm bot", "đb bot", "bot điên", "bot dở", "bot khùng", "đĩ bot", "bot paylac rồi", "con bot lòn", "cmm bot", "clap bot", "bot ncc", "bot oc", "bot óc", "bot óc chó", "cc bot", "bot tiki", "lozz bottt", "lol bot", "loz bot", "lồn bot", "bot như cặc", "bot lồn", "bot lon", "bot cac", "bot nhu lon", "bot như cc", "bot như bìu", "Bot sida", "bot sida", "bot fake", "mạnh ngu", "bot shoppee", "bot đểu", "bot dỡm", "bot zẻ zách", "bot như cức", "Hoàng ngu","Hoàng gà", "hoàng ngu", "Hoang ngu", "sv bot", "hoang ngu", "minh ngu", "Minh ngu", "Hoang oc cho","bot lonnn"].forEach((a => {
